...
def validationCurve(X, y, Xval, yval):
    ...
    lambda_vec =np.linspace(0.0,10.0,100)
...
data = loadmat(os.path.join('Exercise5/Data', 'ex5data1.mat'))
...
lambda_ = 0.4
theta = utils.trainLinearReg(linearRegCostFunction, X_poly, y,lambda_, maxiter=55)
